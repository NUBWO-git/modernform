...
// ดึงข้อมูลจากตาราง refeerece_table
$sql = "SELECT id, name, image, category, created_at FROM refeerece_table ORDER BY $orderBy";
...
if ($result->num_rows > 0) {
   ...
   while ($row = $result->fetch_assoc()) {
      ...
      $imageURL = "./Refeerece table/uploads/" . $row['image']; // ปรับให้เป็น URL ที่ถูกต้อง
