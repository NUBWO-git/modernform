...
// ดึงข้อมูลจากตาราง ergonomic
$sql = "SELECT id, name, image, category, created_at FROM ergonomic ORDER BY $orderBy";
...
if ($result->num_rows > 0) {
   ...
   while ($row = $result->fetch_assoc()) {
      ...
      $imageURL = "./ERGONOMIC table/uploads/" . $row['image']; // ปรับให้เป็น URL ที่ถูกต้อง
