...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/WORKING%20DESIGN%20SOLUTION/WORKING%20DESIGN%20SOLUTION.php?sort=${sortOrder}`)
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const defaultTitle = "WORKING DESIGN SOLUTION"; // ชื่อเมนูหน้าหลัก
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function renderGallery(filteredProducts) {
      ...
      categoryFiltered.forEach(product => {
         const imgElement = document.createElement("img");
         imgElement.src = product.src;  // ใช้ src ที่ได้จากข้อมูลสินค้า
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/WORKING%20DESIGN%20SOLUTION/WORKING%20DESIGN%20SOLUTION.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/WORKING%20DESIGN%20SOLUTION/WORKING%20DESIGN%20SOLUTION.php");
