...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/Closet/CUSTOM%20WALK-IN%20CLOSET.php?sort=${sortOrder}`)
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const defaultTitle = "CUSTOM WALK-IN CLOSET"; // ชื่อเมนูหน้าหลัก
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/Closet/CUSTOM%20WALK-IN%20CLOSET.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/Closet/CUSTOM%20WALK-IN%20CLOSET.php");
   ...
   elements.forEach(function (element) {
      element.addEventListener("click", function () {
         ...
         if (element.tagName === "P") {
            ...
            targetUrl = "http://localhost/modernform/PET%20COLLECTION/CUSTOM%20KITCHEN/CUSTOM%20KITCHEN.html";
         }
