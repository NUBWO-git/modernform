...
// ดึงข้อมูลจากตาราง steelcase_table
$sql = "SELECT id, name, image, category, created_at FROM steelcase_table ORDER BY $orderBy";
$result = $conn->query($sql);

$images = [];
if ($result->num_rows > 0) {
   while ($row = $result->fetch_assoc()) {
      $imageURL = "Steelcase/uploads/" . $row['image'];
