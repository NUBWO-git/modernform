...
// ดึงข้อมูลจากตาราง Collection
$sql = "SELECT id, name, image, category, created_at FROM Collection ORDER BY $orderBy";
...
if ($result->num_rows > 0) {
   ...
   while ($row = $result->fetch_assoc()) {
      ...
      $imageURL = "Collection Table/uploads/" . $row['image']; // ปรับให้เป็น URL ที่ถูกต้อง
