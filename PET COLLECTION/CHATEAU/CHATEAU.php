...
// ดึงข้อมูลจากตาราง chateau
$sql = "SELECT id, name, image, category, created_at FROM chateau ORDER BY $orderBy";
...
if ($result->num_rows > 0) {
   ...
   while ($row = $result->fetch_assoc()) {
      ...
      $imageURL = "chateau table/uploads/" . $row['image']; // ปรับให้เป็น URL ที่ถูกต้อง
