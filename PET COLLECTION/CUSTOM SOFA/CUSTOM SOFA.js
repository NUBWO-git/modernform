...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/CUSTOM%20SOFA/CUSTOM%20SOFA.php?sort=${sortOrder}`)
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/CUSTOM%20SOFA/CUSTOM%20SOFA.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/CUSTOM%20SOFA/CUSTOM%20SOFA.php");
