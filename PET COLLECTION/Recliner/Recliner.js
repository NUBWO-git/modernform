...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/Recliner/Recliner.php?sort=${sortOrder}`)
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const defaultTitle = "ERGONOMIC RECLINER"; // ชื่อเมนูหน้าหลัก
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/Recliner/Recliner.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/Recliner/Recliner.php");
