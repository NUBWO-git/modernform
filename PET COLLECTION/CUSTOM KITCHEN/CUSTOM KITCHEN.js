...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/CUSTOM%20KITCHEN/CUSTOM%20KITCHEN.php?sort=${sortOrder}`)
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const defaultTitle = "CUSTOM KITCHEN"; // ชื่อเมนูหน้าหลัก
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/CUSTOM%20KITCHEN/CUSTOM%20KITCHEN.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/CUSTOM%20KITCHEN/CUSTOM%20KITCHEN.php");
   ...
   elements.forEach(function (element) {
      element.addEventListener("click", function () {
         ...
         if (element.tagName === "P") {
            ...
            targetUrl = "http://localhost/modernform/PET%20COLLECTION/ERGONOMIC/ERGONOMIC%20RRCLINER.html";
         } 
