...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/DESIGN%20AWARDS/DESIGN%20AWARDS.php?sort=${sortOrder}`)
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   const defaultTitle = "DESIGN AWARDS COLLECTION"; // ชื่อเมนูหน้าหลัก
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/DESIGN%20AWARDS/DESIGN%20AWARDS.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/DESIGN%20AWARDS/DESIGN%20AWARDS.php");
   ...
   elements.forEach(function (element) {
      element.addEventListener("click", function () {
         ...
         if (element.tagName === "P") {
            ...
            targetUrl = "http://localhost/modernform/modernform.html";
         } 
