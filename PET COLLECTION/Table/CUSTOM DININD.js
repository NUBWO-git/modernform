...
document.addEventListener("DOMContentLoaded", function () {
   ...
   function fetchDataAndUpdate(sortOrder) {
      fetch(`http://localhost/modernform/PET%20COLLECTION/Table/CUSTOM%20DININD.php?sort=${sortOrder}`)
...
document.addEventListener('DOMContentLoaded', function () {
   ...
   function fetchProducts(category = null) {
      const url = new URL('http://localhost/modernform/PET%20COLLECTION/Table/CUSTOM%20DININD.php');
      const params = {};
...
document.addEventListener("DOMContentLoaded", function () {
   ...
   async function fetchImages() {
      try {
         ...
         const response = await fetch("http://localhost/modernform/PET%20COLLECTION/Table/CUSTOM%20DININD.php");
   ...
   elements.forEach(function (element) {
      element.addEventListener("click", function () {
         ...
         if (element.tagName === "P") {
            ...
            targetUrl = "http://localhost/modernform/PET%20COLLECTION/Closet/CUSTOM%20WALK-IN%20CLOSET.html";
         }
